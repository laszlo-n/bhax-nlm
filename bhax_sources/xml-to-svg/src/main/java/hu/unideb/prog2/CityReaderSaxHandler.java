...
public class CityReaderSaxHandler extends DefaultHandler implements XmlReader {
    ...
    public CityReaderSaxHandler(InputStream input) throws ParserConfigurationException, SAXException, IOException {
